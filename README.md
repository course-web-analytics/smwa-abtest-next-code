# Social Media and Web Analytics: A/B Tests - Next Steps
...
```{bash, eval = FALSE}
git clone https://github.com/tisem-digital-marketing/smwa-abtest-next-code.git
```
...
Deer, Lachlan. 2025. Social Media and Web Analytics: A/B Tests: Next Steps -- Code. Tilburg University. url = "https://github.com/tisem-digital-marketing/smwa-abtest-next-code"

```{r, engine='out', eval = FALSE}
@misc{smwa-abtests-next-2025,
      title={"Social Media and Web Analytics:  A/B Tests: Next Steps -- Code"},
      author={Lachlan Deer},
      year={2025},
      url = "https://github.com/tisem-digital-marketing/smwa-abtest-next-code"
}
```
